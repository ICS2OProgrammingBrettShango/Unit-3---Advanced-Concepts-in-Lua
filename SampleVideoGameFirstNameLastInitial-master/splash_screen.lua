...
local function moveBeetleship()
    princess.x = princess.x + scrollXSpeed
    princess.y = princess.y + scrollYSpeed
end
...
function scene:create( event )
    ...
    princess = display.newImageRect("Images/princess.png", 200, 200)
    Pink = display.newImageRect("Images/Pink.png,", 200, 200)
